...
## Connections
- Related papers: RT-1（前作），[[2410-Pi0|π0]]（用 flow matching 取代 token 预测），[[2406-OpenVLA|OpenVLA]]（开源复现 VLA 范式），[[2405-Octo|Octo]]
- Related ideas: Actions as language tokens, VLM for embodied AI
