...
## Connections
- Related papers: [[2602-GTA]]（task planning），[[2602-GigaBrain]]（reasoning），[[2601-Thinker]]（thinking for embodied），[[2512-Lumo1]]（LLM reasoning），[[2504-EmbodiedR]]（embodied reasoning）
- Related ideas: RAP 的 world model 思想与 embodied AI 中的 world model 一脉相承，但前者用 LLM 做 mental simulation，后者用 learned dynamics model 做 physical simulation；inference-time scaling 的早期代表工作
- Related projects: LLM Reasoners (https://github.com/Ber666/llm-reasoners)
