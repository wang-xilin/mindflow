...
## Connections
- Related papers: [[2507-StreamVLN]]（SFT+DAgger 路线的 SOTA，形成训练范式对比）, [[2512-EfficientVLN]]（同样基于 MLLM 的高效 VLN）, [[2402-NaVid]]（Video-based VLM for VLN 先驱）, [[2412-NaVILA]]（VLA for navigation，不同 action space 设计）, [[2304-ETPNav]]（waypoint-based VLN baseline）, [[2411-RewardHacking]]（reward design 相关）
- Related ideas: GRPO 在 navigation 中的 scaling（更多 RL data、更大模型）；TDR 可扩展到其他 sequential decision-making tasks
- Related projects:
