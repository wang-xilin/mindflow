...
## Connections
- Related papers: [[2501-Cosmos]]（world foundation model 平台）、[[2504-UWM]]（universal world model）、[[2602-DreamZero]]（world model + planning）、[[2501-RoboticWorldModel]]（robotic world model survey）、[[2602-WorldVLALoop]]（world model in VLA loop）、[[2505-DreamGen]]（video generation for robotics）
- Related ideas: representation space 中做 planning 而非 pixel space generation 是重要的 efficiency insight；self-supervised pretraining 的 data efficiency 优势值得在 VLA 领域探索
- Related projects: Meta FAIR robotics 生态，LeCun 的 JEPA 系列
