...
## Connections
- Related papers:
  - [[2410-Pi0]] — π₀ base architecture，flow matching action expert
  - [[2504-Pi05]] — π₀.₅ hierarchical inference，π*₀.₆ 的 pre-trained base
  - [[2603-MEM]] — 基于 π₀.₆ 的多尺度记忆，共享 base model
  - [[2603-RoboClaw]] — 另一种 VLA 自我改进方式（autonomous data collection），与 Recap 互补
- Related topics:
  - [[VLN-VLA-Unification]] — Recap 可以用于统一系统的 manipulation head RL fine-tuning
