...
## Connections
- Related papers:
  - [[2309-ConceptGraphs]] — 同样构建 3D scene representation，但 ConceptGraphs 是离线重建，MTU3D 是在线
  - [[2210-VLMaps]] — VLMaps 也做 language-queryable spatial map，MTU3D 的 spatial memory bank 是其在线版本
  - [[2312-SplaTAM]] — SplaTAM 做 dense SLAM，MTU3D 用 sparse query representation 替代
  - [[2412-NaVILA]] — NaVILA 用 VLM 做 navigation，MTU3D 用 specialized architecture 而非通用 VLM
  - [[2304-ETPNav]] — ETPNav 也做 topological planning + exploration，但没有 joint grounding
  - [[2401-OKRobot]] — OK-Robot 是 modular nav+manip 系统，MTU3D 的 spatial memory 可以替代其 VoxelMap
- Related ideas:
  - [[Hierarchical-VLA-SceneGraph]] — MTU3D 的 online spatial memory 是实现 "shared semantic scene graph" 的一种具体方案
- Related topics:
  - [[VLN-VLA-Unification]] — MTU3D 从 VLN 侧推进了 grounding + exploration 的统一，但尚未涉及 manipulation
