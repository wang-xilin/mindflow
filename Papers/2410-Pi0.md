...
## Connections
- Related papers: [[2504-Pi05|π0.5]]（π₀ 的后续，加入 open-world generalization）, [[2603-RoboClaw]]（使用 π0.5 作为底层 VLA policy）
- Related ideas: Diffusion Policy, ACT (Action Chunking Transformer), OpenVLA, RT-2-X, Octo
